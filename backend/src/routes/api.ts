 ...
 *               data: []
 */
router.get('/resumes', (req: Request, res: Response) => {
  res.json({
    success: true,
    message: 'Get all resumes endpoint',
    data: []
 ...
 */
router.get('/resumes/:id', (req: Request, res: Response) => {
  const { id } = req.params;
  res.json({
    success: true,
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/resumes', (req: Request, res: Response) => {
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/resumes/:id', (req: Request, res: Response) => {
  const { id } = req.params;
  const resumeData = req.body;
  res.json({
    success: true,
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/resumes/:id', (req: Request, res: Response) => {
  const { id } = req.params;
  res.json({
    success: true,
