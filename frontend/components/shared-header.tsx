...
export function SharedHeader({ variant = 'landing' }: SharedHeaderProps) {
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              {isLanding && (
                <button
                  ...
                  className="px-3 sm:px-4 py-2 text-sm sm:text-base text-zinc-600 hover:text-black transition-colors font-medium"
                >
                  Create Resume
                </button>
              )}
